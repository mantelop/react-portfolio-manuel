   ...
   <div id='home' style={{backgroundImage: `url(${bg})`}} className=' bg-center bg-cover bg-no-repeat h-screen flex flex-col '>
    ...
    <div className="wrapper flex justify-between items-center h-screen w-full px-20 lg:justify-center lg:px-6">
      <div className="content lg:text-center">
        ...
        <p className='text-white py-4 max-w-lg '>Soy recien titulado bla bla bla</p>
        <button className='  text-white text-2xl'>Contacta<i className="fa-solid fa-arrow-right text-lg  p-[2px] "></i> </button>
      </div>
